...
const enterpriseSystems = [
  ...
  { id: 'recruitment', name: 'Recruitment System', iconName: 'Users', desc: 'Runs candidate screening on autopilot, handling interview staging to ensure you never lose top talent to competitors.', tier: 'Enterprise Tier', complexity: 'High' },
