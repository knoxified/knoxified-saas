...
export default function CartRevivePage() {
  const jsonLd = {
    ...
    <div className="container mx-auto px-4 py-24 max-w-7xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800/80 backdrop-blur-md border border-cyan-500/30 text-sm font-medium text-cyan-400 mb-8 shadow-[0_0_15px_rgba(6,182,212,0.15)]">
             <Settings className="w-4 h-4" /> CartRevive 🛒
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-50 mb-6 tracking-tight leading-tight">Abandoned Cart Recovery</h1>
          <p className="text-xl font-medium text-cyan-400 mb-6">Engages with abandoned cart customers on SMS and WhatsApp, offering intelligent discounts and recovering sales.</p>
          <div className="text-lg text-slate-400 mb-10 leading-relaxed space-y-4">
            <p>Don't let interested buyers slip away. Instantly reach them on the platforms they use most and bring them back to complete the purchase.</p>
          </div>
      ...
      <div className="mb-24">
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {["Multi-channel outreach (SMS, WhatsApp, Email)", "Dynamic intelligent discounts", "Answers customer objections and FAQs", "Deep integration with Shopify and Woo", "A/B testing on messaging flows", "Detailed attribution and ROI reporting"].map((feature, idx) => (
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-24">
        <div className="p-8 md:p-12 rounded-3xl bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 relative overflow-hidden">
           ...
           <p className="text-slate-400 text-lg leading-relaxed mb-6 relative z-10">
             An aggressive, conversational sales recovery agent that engages abandoned carts where your customers actively chat.
           </p>
           <p className="text-slate-400 text-lg leading-relaxed mb-6 relative z-10">
             By delegating this specific task to an automation, you remove passive follow-ups, eliminate lost revenue, and consistently rescue high-intent buyers.
           </p>
        </div>
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 relative overflow-hidden flex flex-col justify-center">
           ...
           <div className="space-y-6 mb-8 relative z-10">
            {["Average 15-25% increase in recovered carts","Dynamic discounts protect margins","Immediate customer feedback loop"].map((benefit, idx) => (
      ...
      <div className="p-12 md:p-16 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700/50 text-center relative overflow-hidden shadow-2xl">
         <div className="relative z-10">
           ...
           <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">Activate Knoxified CartRevive today and start automating.</p>
           <Link href="/pricing" className="inline-flex items-center gap-2 px-10 py-5 bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold rounded-full transition-all shadow-[0_0_30px_rgba(6,182,212,0.4)]">
              Deploy CartRevive <ChevronRight className="w-5 h-5 flex-shrink-0" />
           </Link>
         </div>
      </div>
    </div>
