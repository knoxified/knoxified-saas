...
export default function PulsePayPage() {
  const jsonLd = {
    ...
    <div className="container mx-auto px-4 py-24 max-w-7xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800/80 backdrop-blur-md border border-cyan-500/30 text-sm font-medium text-cyan-400 mb-8 shadow-[0_0_15px_rgba(6,182,212,0.15)]">
             <Settings className="w-4 h-4" /> PulsePay 💳
          </div>
          ...
          <p className="text-xl font-medium text-cyan-400 mb-6">
            Automatically engages customers whose credit cards decline to recover lost recurring revenue.
          </p>
          <div className="text-lg text-slate-400 mb-10 leading-relaxed space-y-4">
            <p>
              A silent collections agent that patches the biggest leak in subscription-based businesses.
            </p>
          </div>
      ...
      <div className="mb-24">
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {["Detects failed Stripe, PayPal, or Braintree transactions instantly","Initiates a polite, automated email sequence to prompt card updates","Sends secure 'update billing' links directly to the customer","Attempts intelligent retries on specific days to maximize success","Pauses accounts if payments remain unrecovered","Alerts the customer success team for high-value account failures"].map((feature, idx) => (
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-24">
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 relative overflow-hidden flex flex-col justify-center">
           ...
           <div className="space-y-6 mb-8 relative z-10">
            {["Up to 40% churn recovery","Protects recurring revenue","Requires zero awkward phone calls"].map((benefit, idx) => (
      ...
      <div className="p-12 md:p-16 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700/50 text-center relative overflow-hidden shadow-2xl">
         ...
         <div className="relative z-10">
           ...
           <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
             Activate Knoxified PulsePay today and start automating.
           </p>
           <Link href="/pricing" className="inline-flex items-center gap-2 px-10 py-5 bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold rounded-full transition-all shadow-[0_0_30px_rgba(6,182,212,0.4)] hover:shadow-[0_0_50px_rgba(6,182,212,0.6)] hover:-translate-y-1 text-lg">
              Deploy PulsePay <ChevronRight className="w-5 h-5 flex-shrink-0" />
           </Link>
         </div>
      </div>
