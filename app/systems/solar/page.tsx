    ...
    <div className="container mx-auto px-4 py-24 max-w-7xl">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        <div>
          ...
          <AIVoiceSample 
            industry="solar"
            text="Hi, this is Knoxified Solar. Switching to renewable energy shouldn&apos;t be confusing. I can instantly verify your roof&apos;s sun exposure and calculate your exact state tax incentives. Ready to see how much you could save on your monthly bill?"
          />
