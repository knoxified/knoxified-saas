          ...
          <div className="text-lg text-slate-400 mb-10 leading-relaxed space-y-4">
            ...
            <p>
              Tenant inquiries, emergency maintenance triaging, rent reminders, vendor coordination, and lease renewal follow-ups are fully automated, keeping tenants happy and owners profitable.
                                        ...
                                        <AIVoiceSample 
            industry="property"
            text="Hello from Knoxified Property Management. If something&apos;s broken and you need it handled fast, I can get that logged right now instead of it sitting in a queue. Or if you&apos;re looking at one of our vacant units, I&apos;m happy to set up a tour. Which brings you in today?"
          />
